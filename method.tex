...
prefix and \texttt{.py} suffix.  If required, this can be followed by
one or more whitespaces and a token ``\texttt{py2}'' or
``\texttt{py3}'', indicating which Python version to use when
executing the method.  If the method works on both versions, this
field is left blank.  Here is an example
\begin{shell}
# this is a comment
