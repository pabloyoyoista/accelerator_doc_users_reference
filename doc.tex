...
% minted Shell
\newminted[shell]{bash}{bgcolor=bg}

% minted json
\newminted[json]{json}{bgcolor=bg}
...
\def\starttable{%
  ...
  \begin{snugshade}
    \noindent\begin{longtable}{@{}p{3.2cm}p{1.8cm}p{8cm}}\hline\\[-1ex]
...
\def\starttablenoheader{%
  ...
  \begin{snugshade}
    \noindent\begin{longtable}{@{}p{3.2cm}p{1.8cm}p{8cm}}\hline\\[-1ex]}
\def\stoptable{\\[1ex]\hline\end{longtable}\end{snugshade}}
\def\RP #1&#2&#3{ #1&#2&#3}
