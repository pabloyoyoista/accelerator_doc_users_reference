...
\starttabletwo
\texttt{datasetwriter()} & Returns a DatasetWriter object.  See documentation for \texttt{DatasetWriter()}, section~\ref{sec:classes:datasetwriter}.\\
...
\subsection{\texttt{Job.link\_result()}}
\starttable
\texttt{filename} & \textsl{Mandatory} & Name of file in job directory.\\
...
\subsection{\texttt{CurrentJob.input\_filename()}}
...
\subsection{\texttt{CurrentJob.open\_input()}}
...
\subsection{\texttt{CurrentJob.register\_file()}}
