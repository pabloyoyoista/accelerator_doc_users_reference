...
All boolean arguments (e.g. \texttt{---headers}, \texttt{---allow-missing-columns})
have corresponding \texttt{---no-}/\texttt{---not-}/\texttt{---dont-} versions
(e.g. \texttt{---no-headers}, \texttt{---dont-allow-missing-columns}).
...
ax init
\end{shell}
This command creates everything required for starting a project,
