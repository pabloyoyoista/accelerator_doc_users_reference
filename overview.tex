...
If the same workdir definition is entered into two or more user's
...
jobs.  Thus, only one user have to execute a given method for all
other users to have access to it.  This can save a lot of time in a
project.
