...
\RPtwo \texttt{caption} & A caption string.  For decorative purposes
    only, this has no practical use.\\

\RPtwo \texttt{concurrency} & Specify max number of parallel processes.
