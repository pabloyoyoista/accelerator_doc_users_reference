...
\end{python}
If update is True, the entry in the test list at '2016-10-25' will be
...
\begin{python}
urd.truncate('test', '2016-09-30')
\end{python}
This will rollback everything that has happened in the \texttt{test}
list back to '2016-09-30'.  There is also a special case,
\begin{python}
...
for timestamp \texttt{2018-04-03}.  So, if there is a question in the
